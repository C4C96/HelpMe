...
public class ProfileConnection extends URLConnection
{
    //URL地址（真机+本地服务器测试）：http://192.168.0.3:8080/AndroidServlet/ProfileServlet
    //URL地址（模拟器+远程云服务器测试）：http://123.206.125.166:8080/AndroidServlet/ProfileServlet
    public HttpURLConnection urlConnection = null;
    public URL url = null;

    public ProfileConnection(URL url)
    {
        super(url);
        this.url=url;
